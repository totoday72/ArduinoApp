...
char pass[] = "KKBGVVJK";   // your network password
...
unsigned long correcto=0;
unsigned long incorrecto=0;
...
void loop() {
  ...
  delay(200); // No need to read the temperature too often.
/*
  ...
  delay(200); // No need to read the counter too often.
  */
}
